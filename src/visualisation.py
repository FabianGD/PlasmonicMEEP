...
def argparsing():
    ...
    """
    parser = argparse.ArgumentParser(description="Visualize calculated field enhancement")
...
def main():
    ...
    # visualize data
    multi_slice_viewer(
        data[skip_x:-skip_x, skip_y:-skip_y, :], index_function=lambda x: 1000 / freqs[x]
    )
